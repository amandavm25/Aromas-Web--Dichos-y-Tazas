...
function initializeModals() {
    ...
    botonesDetalles.forEach(boton => {
        boton.addEventListener('click', function () {
            ...
            document.getElementById('detalles-id-modulo').textContent = id;
            document.getElementById('detalles-nombre-modulo').textContent = nombre;
            document.getElementById('detalles-descripcion-modulo').textContent = descripcion;
    ...
    botonesEliminar.forEach(boton => {
        boton.addEventListener('click', function () {
            ...
            document.getElementById('eliminar-id-display-modulo').textContent = id;
            document.getElementById('eliminar-id-modulo').value = id;
            document.getElementById('eliminar-nombre-modulo').textContent = nombre;
            document.getElementById('eliminar-descripcion-modulo').textContent = descripcion;
            ...
            form.action = '/Modulo/EliminarModulo/' + id;
        });
    });
}
